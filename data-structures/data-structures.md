...
Структуры данных - упорядоченные хранилища данных в определенном формате. Некое количество элементов, которые имеют между собой внутренние связи.

Структуры данных тесно связаны с алгоритмами, которые позволяют обрабатывать данные.

**Изменчивость структуры** — изменение количества элементов и связей между ними.
