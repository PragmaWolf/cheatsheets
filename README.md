...
- WIP: [Функциональное программирование](paradigms/functional.md)
- WIP: [Логическое программирование](paradigms/logical.md)
- WIP: [Объектно-ориентированное программирование (ООП)](paradigms/object-oriented.md)
  - WIP: [Компонентно-ориентированное программирование](paradigms/component-oriented.md)
  - WIP: [Прототипно-ориентированное программирование](paradigms/prototype-oriented.md)
...
- WIP: [Доказательное программирование](paradigms/evidential.md)
- WIP: [Порождающее программирование](paradigms/generative.md)
- WIP: [Аспектно-ориентированное программирование (АОП)](paradigms/aspect-oriented.md)
- WIP: [Агентно-ориентированное программирование](paradigms/agent-oriented.md)
- WIP: [Контрактное программирование](paradigms/contractual.md)
- WIP: [Автоматное программирование](paradigms/automatic.md)
- WIP: [Событийно-ориентированное программирование](paradigms/event-oriented.md)
- WIP: [Прототипно-ориентированное программирование](paradigms/prototype-oriented.md)
- WIP: [Компонентно-ориентированное программирование](paradigms/component-oriented.md)
...
- [Стеки (Stacks)](data-structures/stacks.md)
- [Очереди (Queues)](data-structures/queues.md)
- [Списки (Lists)](data-structures/lists.md)
  - WIP: [Односвязнный (однонаправленный) список (Single-linked list)](data-structures/lists.single-linked.md)
  - WIP: [Двусвязнный (двунаправленный) список (Double-linked list)](data-structures/lists.double-linked.md)
  - WIP: [Кольцевой связный список (Ring linked list)](data-structures/lists.ring-linked.md)
  - WIP: [Развёрнутый связный список (Expanded linked list)](data-structures/lists.expanded-linked.md)
  - WIP: [Список с пропусками (Skip List)](data-structures/lists.skip.md)
  - WIP: [XOR-связный список (XOR linked list)](data-structures/lists.xor-linked.md)
- [Хэш-таблицы, Хэш-мапы (Hash tables, Hash Maps)](data-structures/hash-maps.md)
- [Множества, Хэш-сеты (Sets, Hash Sets)](data-structures/hash-sets.md)
- [Карты, Словари (Maps, Dictionaries)](data-structures/maps.md)
- [Графы (Graphs)](data-structures/graphs.md)
- WIP: [Деревья (Trees)](data-structures/trees.md)
  - WIP: [Бинарное дерево (Binary tree)](data-structures/trees.binary.md)
  - WIP: [Бинарное дерево поиска (Binary search tree)](data-structures/trees.binary-search.md)
  - WIP: [Красно-чёрное дерево (Red-black tree)](data-structures/trees.red-black.md)
  - WIP: [AVL-дерево (AVL tree)](data-structures/trees.avl.md)
  - WIP: [T-дерево (T-tree)](data-structures/trees.t.md)
  - WIP: [Декартово дерево (Cartesian tree)](data-structures/trees.cartesian.md)
  - WIP: [B-дерево (B-tree)](data-structures/trees.b.md)
  - WIP: [Splay дерево (Splay tree)](data-structures/trees.splay.md)
  - WIP: [KD дерево (KD tree)](data-structures/trees.kd.md)
  - WIP: [Деревья квадрантов (Quadrant trees)](data-structures/trees.quadrant.md)
  - WIP: [K-мерные деревья (K-dimensional trees)](data-structures/trees.k-dimensional.md)
  - WIP: [Префиксные деревья, Бор, Нагруженное дерево (Trie, Prefix Trees)](data-structures/trees.trie.md)
